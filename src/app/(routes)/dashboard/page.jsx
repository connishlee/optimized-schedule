...
export default function DashboardPage() {
  ...
  const handleAddTask = (e) => {
    ...
    setTasks(prev => ({
      ...prev,
      [selectedDay]: [...prev[selectedDay], taskWithId]
    }));
    setNewTask({ name: "", description: "", startTime: "", endTime: "", completed: false, id: "" });
  };
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className={`font-medium text-lg mt-1 ${task.completed ? 'line-through text-gray-400' : ''}`}>
                          {task.name}
                        </div>
                        <div className="text-gray-400 text-sm mt-1">
                          {task.description}
                      ...
                      <div className="flex space-x-2 ml-4">
                        <button 
                          ...
                          className={`p-1.5 rounded-full transition-colors
                            ${task.completed ? 'bg-green-500/20 text-green-400' : 'bg-gray-700 text-gray-400'}
                        ...
                        <button 
                          ...
                          className="p-1.5 rounded-full bg-gray-700 text-gray-400 hover:bg-red-500/30 hover:text-red-400 transition-colors"
                        >
                          ✕
                        </button>
                      </div>
